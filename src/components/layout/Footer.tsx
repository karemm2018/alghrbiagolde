    ...
    <footer className="relative bg-gradient-to-b from-[#060D1A] via-[#0A1628] to-[#060D1A] pt-24 pb-0 overflow-hidden flex flex-col justify-between" dir="rtl">
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          <div className="flex flex-col space-y-6">
            <div className="flex items-center gap-3 text-right">
              ...
              <div>
                ...
                <p className="text-[8px] text-white/80 tracking-[0.2em] font-serif uppercase font-medium mt-1">
                  GOLDEN WESTERN
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3 pt-2">
              {/* License Row */}
              <div className="flex items-center justify-between p-3 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-gold-primary/50 transition-all duration-300">
                <div className="text-right">
                  <span className="block text-[8px] text-slate-500">الترخيص العقاري (فال)</span>
                  <span className="block text-[11px] font-bold text-slate-800 font-mono">1200021665</span>
                </div>
                <div className="relative w-11 h-11 flex items-center justify-center shrink-0">
                  <Image
                    src="/fal.webp"
                    alt="ترخيص فال العقاري"
                    width={44}
                    height={44}
                    className="object-contain"
                  />
              ...
              <div className="flex items-center justify-between p-3 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-gold-primary/50 transition-all duration-300">
                <div className="text-right">
                  <span className="block text-[8px] text-slate-500">الهيئة العامة للعقار</span>
                  <span className="block text-[11px] font-bold text-slate-800 font-mono">الترخيص: 1100018593</span>
                </div>
                <div className="relative w-18 h-10 flex items-center justify-center shrink-0">
                  <Image
                    src="/rega_logo.webp"
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-6 mb-16 border-t border-white/5 relative z-10">
          ...
          <div className="text-right text-[10px] text-slate-400 leading-relaxed font-el-messiri">
            ...
            <p>جدة، حي السلامة، طريق الأمير سلطان | البريد الإلكتروني: info@alghrbia.sa | Golden Western Real Estate Development</p>
          </div>
        </div>
      ...
      <div className="w-full relative z-10 border-t border-white/5 bg-[#060D1A]/90 backdrop-blur-md pt-8 pb-10">
        <div className="max-w-7xl mx-auto px-4 text-center text-slate-400 text-[10px] sm:text-xs">
          <p className="font-mono">&copy; {new Date().getFullYear()} GOLDEN WESTERN. All Rights Reserved.</p>
